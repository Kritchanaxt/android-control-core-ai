...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        android.util.Log.d(TAG, "Created program " + mProgramHandle + " (" + programType + ")");
        ...
        if (muExposureCompensationLoc >= 0) {
            android.util.Log.d(TAG, "Found exposure compensation uniform at location: " + muExposureCompensationLoc);
        }
    }
     ...
     */
    public void release() {
        android.util.Log.d(TAG, "deleting program " + mProgramHandle);
